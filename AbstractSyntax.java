...
class Functions extends ArrayList<Function> {
    ...
    public Function NametFunction(String name) {
        for (Function functionList : this) {
            if (functionList.id.equals(name)) {
                return functionList;
            }
        }
        return null;
    ...
    public Declarations allFunctionsName() {
...
class Function {
    ...
    public Function(Type t, String id, Declarations p, Declarations l, Block b) {
        this.t = t;
        this.id = id;
        this.params = p;
        this.locals = l;
    ...
    public void display(int k) {
        ...
        k++;
        System.out.println("Function = " + id + "; Return type = " + t);
        for (int w = 0; w < k; ++w) {
            System.out.print("\t");
        }
